<template>
  <div id="volume-container">
    ...
    <div class="toolbox" id="info">
      <div>
        <h3 id="status">Loading...</h3>
      </div>
    </div>

    <div class="toolbox" id="colourmap">
      <div>
        ...
        <div id="backgroundBG" class="colourbg checkerboard">
          <div id="backgroundCUR" class="colour" onmousedown="colours.editBackground($('backgroundCUR'));">
          </div>
        </div>
...
<script>
import { initPage, destroyPage } from './sharevol.js'
export default {
  mounted() {
    setTimeout(() => {
      initPage();
