...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='JudgeInfo',
            fields=[
                ('dtId', models.AutoField(primary_key=True, serialize=False)),
                ('project', models.CharField(max_length=255, verbose_name='工程名称')),
                ('mileage', models.CharField(max_length=255, verbose_name='施工里程')),
                ('width', models.DecimalField(decimal_places=2, default=8.8, max_digits=10, null=True, verbose_name='开挖宽度')),
                ('height', models.DecimalField(decimal_places=2, default=8.8, max_digits=10, null=True, verbose_name='开挖高度')),
